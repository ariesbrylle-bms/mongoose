...
exports.addOrder = function(req, res) {
    let order = new Order(
        {
            transactionNo: new Date().getFullYear() + '-' + new Date().getMonth() + new Date().getMilliseconds()+ '-' + new Date().getDay() + '-' + Math.random().toString(36).substr(2, 5).toUpperCase(), // eslint-disable-line
